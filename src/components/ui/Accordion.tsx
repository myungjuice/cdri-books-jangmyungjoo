...
function AccordionTrigger({
  ...
  trigger,
  ...props
}: React.ComponentProps<typeof AccordionPrimitive.Trigger> & { trigger?: React.ReactNode }) {
  return (
...
export { Accordion, AccordionItem, AccordionTrigger, AccordionContent, AccordionArrowIcon };
